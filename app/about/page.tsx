            ...
            <div className="flex flex-col gap-2 h-full">
                ...
                <div className="flex md:flex-row flex-col-reverse  gap-2 h-full">
                    <div className="basis-full bg-gray-400 rounded-md flex justify-center items-center p-2 h-full">
                        <h1 className="text-2xl font-bold text-center">About Info</h1>
                    </div>
                    <div className="basis-full bg-gray-400 rounded-md p-2 flex flex-col gap-2 h-full">
                        <h1 className="text-2xl font-bold text-center">Data Details</h1>
