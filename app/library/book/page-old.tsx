...
export default function Home() {
    ...
    // let thumbnail = "https://d1csarkz8obe9u.cloudfront.net/posterpreviews/old-books-cover-design-template-528851dfc1b6ed275212cd110a105122_screen.jpg?ts=1698687093";
    ...
    // search book data in the google sheet database
    const showSearchResults = useCallback(async () => {
        const data: string[] = await searchSheetData("Books", "A2:C", isbn ?? "", 0);

        // set thumbnail from google sheet data
        setThumbnail(data[0][2]);
        // console.log(data[0][2]);
        // console.log("This is the book data from google sheet: ", data);
    }, [setThumbnail, isbn]);
    ...
    const [bookLink, setBookLink] = useState<string>("Loading...");
    ...
    useEffect(() => {
        const main = async () => {
            ...
            if (bookData && bookData.items && bookData.items.length > 0) {
                ...
                setTitle(book.volumeInfo.title || "Unknown Title");
                // setThumbnail(book.volumeInfo.imageLinks.thumbnail);
                setBookLink(book.volumeInfo.previewLink || "https://books.google.com.ph/");
        ...
        main();
        showSearchResults();
    }, [isbn, bookLink, showSearchResults]);

    return (
        <div className="p-2 lg:h-screen text-white">
            <div className="flex flex-col gap-2 lg:h-full">
                <div className="basis-auto bg-gray-400 rounded-md flex justify-between items-center p-2">
                ...
                <div className="basis-full grid grid-flow-col grid-cols-3 gap-2 lg:h-full">
                    <div className='bg-gray-500 rounded-md p-2 lg:col-span-2 lg:col-start-1 lg:row-start-1 row-start-2 col-span-full '>
                    ...
                    {/* book thumbnail */}
                    <div className='rounded-md flex justify-center items-center lg:row-span-2 row-span-1 h-full overflow-hidden col-span-3 lg:col-span-1 col-start-1 lg:col-start-3'>
                        <div className="rounded-xl flex flex-col gap-2">
                            ...
                            <Link href={bookLink} target='_blank' rel="noopener noreferrer" className="bg-gray-300 hover:bg-gray-300 text-gray-700 rounded-md focus:ring-4 focus:outline-none focus:ring-gray-500 p-2 px-4">
                                View Book
                            </Link>
                        </div>
                    ...
                    {/* details */}
                    <div className='bg-gray-300 rounded-md text-gray-800 p-2 lg:col-span-2 col-span-full h-auto'>
                    ...
                    <div className='col-span-full flex'>
                        <div className='flex-1 bg-gray-400 rounded-md p-2'>
                            <p className="text-gray-200 h-full w-full"><strong>Description: </strong> {description}</p>
                        </div>
                    </div>
